...
def top_ten(subreddit):
    ...
    url = requests.get("https://www.reddit.com/r/{}/top.json?limit=10".format(subreddit), headers={"Content-Type": "application/json", "User-Agent": "platform"}, allow_redirects = False)
